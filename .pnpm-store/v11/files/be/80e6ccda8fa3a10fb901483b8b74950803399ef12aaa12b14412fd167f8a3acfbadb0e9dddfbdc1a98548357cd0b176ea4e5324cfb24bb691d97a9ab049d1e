                ...
                extraInitializationsAsync: this._shadersLoaded
                    ...
                    : async () => {
                        if (this.shaderLanguage === 1 /* ShaderLanguage.WGSL */) {
                            await Promise.all([import("./wgsl/shadowOnly.vertex.js"), import("./wgsl/shadowOnly.fragment.js")]);
                        }
                        else {
                            await Promise.all([import("./shadowOnly.vertex.js"), import("./shadowOnly.fragment.js")]);
                        }
