...
- The **situation panel** (left column) is a broadcast-style score bug: base diamond with runner names, ball-strike count, out pips (●●○), and the inning scorecard.
- **Little ballplayers live on the actual diamond**: your leadoff card waits at the on-deck circle, legs it out on contact, runners advance the base paths, scorers cross home, and a homer earns the full trot around the horn. Winning on your final at-bat calls the **WALK-OFF**.
